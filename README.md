...
The AI theme-research workspace demonstrates a governed signal-discovery pipeline across alternative data, news, blogs, macro data, financials, research and catalysts. A model proposes structured candidate themes and instrument mappings; deterministic code independently scores freshness, source reliability, novelty, source breadth, evidence depth, catalysts and contradictions. AI confidence and evidence score remain separate, and themes cannot create targets or orders. The current detector and evidence are synthetic fixtures, documented in [theme research](docs/THEME_RESEARCH.md).
...
See [architecture and roadmap](docs/ARCHITECTURE.md), [execution safety](docs/EXECUTION_SAFETY.md), [broker reconciliation](docs/BROKER_RECONCILIATION.md) and [AI theme research](docs/THEME_RESEARCH.md).
